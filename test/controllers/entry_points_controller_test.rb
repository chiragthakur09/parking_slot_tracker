...
class EntryPointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entry_point" do
    assert_difference('EntryPoint.count') do
      post entry_points_url, params: { entry_point: { location_id: @entry_point.location_id, point: @entry_point.point } }
    end
  ...
  test "should update entry_point" do
    patch entry_point_url(@entry_point), params: { entry_point: { location_id: @entry_point.location_id, point: @entry_point.point } }
